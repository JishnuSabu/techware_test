...
//
//     final apiProductsModel = apiProductsModelFromJson(jsonString);

import 'dart:convert';
import 'dart:ffi';

List<ApiProductsModel> apiProductsModelFromJson(String str) => List<ApiProductsModel>.from(json.decode(str).map((x) => ApiProductsModel.fromJson(x)));

String apiProductsModelToJson(List<ApiProductsModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class ApiProductsModel {
  ...
  factory ApiProductsModel.fromJson(Map<String, dynamic> json) => ApiProductsModel(
